<div>
  ...
  <div>
    ...
    <ol>
      ...
      <li><a href="#usos">Usos de las redes de Computadoras</a></li>
      <li><a href="#negocios">Aplicaciones en los negocios</a></li>
      <li><a href="#domesticas">Aplicaciones domésticas</a></li>
  ...
  <div>
    ...
    <ul>
      <li>Compartir programas y archivos:</li>
        <p>Los programas y sus archivos de datos se pueden guardar en un servidor de archivos, al que pueden accesar muchos usuarios de la red a la misma vez.<p>
      <li>Compartir recursos de Red:</li>
        <p>Los recursos de la red incluyen impresoras, scaners y dispositivos de almacenamiento que se pueden compartir en la red, proporcionando enlaces de comunicación que permitan a  los usuarios interactuar y compartir dispositivos. <p>
      <li>Expansión económica de la Organización:</li>
        <p>Las redes proporcionan una forma económica de aumentar el número de computadoras de una organización o institución, al permitir la conexión de estaciones de trabajo que dan paso al intercambio de información y optimizan el desarrollo de las diferentes actividades de la empresa.  <p>
      <li>Proporcionar una alta fiabilidad:</li>
        <p>El contar con fuentes alternativas de suministro, permite que  todos los archivos puedan duplicarse en dos o tres máquinas, de tal manera que si una no se encuentra disponible, podría utilizarse algunas de las copias. La presencia de múltiples CPU significa que si una de ellas deja de funcionar, las otras pueden ser capaces de encargarse de su trabajo, aunque se tenga un rendimiento global menor.<p>
      <li>Poderoso medio de comunicación:</li>
        <p>Las redes proporcionan un medio de comunicación entre personas que se encuentran muy alejadas entre sí.<p>
